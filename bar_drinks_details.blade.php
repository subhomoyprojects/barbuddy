...
<div class="liquor-holder">
	...
	<div class="category-menu-and-subcatagory-menu-holder">
        <div class="add-drink-back-button-holder">
            <a class="btn btn-basic-custom liquor-special-holder-show" id="drindetkbck_btn" href="{{ url('add-drinks') }}" >Back</a>
        </div>
	   <ul class="nav nav-pills category-menu-holder" id="pills-tab{{$drink_cat_id}}" role="tablist">
            ...
            @if( !empty($allsubcategories) )
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 margin_top_10 drink-price-menual-enter-controller">
                                                                    <div class="row custom_check_and_radio deactive-color-mode vertical-40" >
                                                                        <div class="col-12 col-sm-6">
                                                                            ...
                                                                            ?>
                                                                            <input is_global="{{$global_status}}" type="checkbox" id="{{$all_drinks_data->drink_id}}" global_drink_fk_id="{{$all_drinks_data->is_global_fk_id}}" drink_id="{{$all_drinks_data->drink_id}}" class="checked-enabel drink_checkbox" {{$checked}} value="{{$all_drinks_data->drink_id}}" >
                ...
                <div class="row margin_top_50 saveDrinkChange_btn_container" style="display:none;">
                    ...
                    <div class="col-12 add-drink-back-button-holder">
                        <a class="btn btn-basic-custom liquor-special-holder-show" id="drindetkbck_btn" href="{{ url('add-drinks') }}">Back</a>
                       <!-- <button type="button" class="btn btn-success-custom float-right" data-toggle="modal" data-target="#adddrinkmanually">+ Add Drink</button> -->
                    <button type="button" class="btn btn-success-custom float-right" data-toggle="modal" data-target="#FinalSubmission" id="final_drink_add">+ Final Submission </button>
                    </div> 
                </div>
            @endif
		</div>
